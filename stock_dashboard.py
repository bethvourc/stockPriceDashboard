...
# Important for the minute by minute view of the data
...
if st.sidebar.button('Update'):
    ...
    last_close, change, pct_change, high, low, volume = calculate_metric(data)
...
# Sidebar Price
# 
# Sidebar section for real-timr stock price of selected symbols 
